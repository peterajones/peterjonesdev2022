      ...
      <div className="content">
				<div className={`fade-in ${didMount && "visible"}`}>
							...
							<section className="section section-one">
								...
								<p>
									I am a Front End Web Developer in Toronto and I have been
									building websites for more than 10 years. My background is
									making websites with HTML, CSS and JavaScript from Photoshop
									mockups. I have worked with PHP, mySql, Wordpress, jQuery and
									many other technologies. When mobile devices arrived, I learned
									responsive web design with fluid grids as well as the importance
									of web standards, cross browser compatibility and accessibility.
								</p>
								<p>
								...
								<p>
									...
									challenging but I want to keep building websites using the
									latest and greatest. This site is built using React - a
							...
							<section className="section section-two">
								<div className="left">
									...
									<p>
										...
										mobile menu I wanted to add an animation to the hamburger
										menu. Simply attaching an event listener to an element with{" "}
										<code>getElementById</code> no longer works the way it used to
										be done. You need to <code>setState</code> for that element so
										that when an event is clicked for example, the state is
										changed and the element is re-rendered adding a class.
									</p>
									<p>
							...
							<section className="section section-three">
								...
								<div className="right">
									...
									<p>
										In this section I have converted some past side projects
										written in HTML, CSS and Javascript.
									</p>
									<p>
										The original code is shown in the syntax highlighting sections
										- usually one section for each. For the syntax highlighting I
										used Prism which is a lightweight, extensible syntax
										highlighter. Check out the{" "}
							...
							<section className="section section-five">
								...
								<div className="right">
									...
									<p>
										Go ahead - <Link href="/contact"><a>send me a message</a></Link>. I
